...
public class FloatLabelEditText extends LinearLayout {
    ...
    private int mFocusedColor, mUnFocusedColor, mFitScreenWidth,mTextColor,mTextHintColor,
    ...
    private void getAttributesFromXmlAndStoreLocally() {
        ...
        mTextColor =attributesFromXmlLayout.getColor(R.styleable.FloatLabelEditText_textColor, android.R.color.black);
        mTextHintColor =attributesFromXmlLayout.getColor(R.styleable.FloatLabelEditText_textHintColor, android.R.color.black);
    ...
    private void setupEditTextView() {
        ...
        mEditTextView.setHintTextColor(mTextHintColor);
        mEditTextView.setText(mEditText);
        mEditTextView.setTextColor(mTextColor);
