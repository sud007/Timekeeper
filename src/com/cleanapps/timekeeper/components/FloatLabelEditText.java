...
public class FloatLabelEditText extends LinearLayout {
	...
	private void initializeView() {
		...
		mFloatingLabel = (TextView) findViewById(R.id.custom_comp_floating_label_hint);
		mEditTextView = (EditText) findViewById(R.id.custom_comp_floating_label_edit_text);
	...
	private void showFloatingLabel() {
		...
		mFloatingLabel.startAnimation(AnimationUtils.loadAnimation(
				getContext(), R.anim.slide_from_bottom));
	}

	private void hideFloatingLabel() {
		mFloatingLabel.setVisibility(INVISIBLE);
		mFloatingLabel.startAnimation(AnimationUtils.loadAnimation(
				getContext(), R.anim.slide_to_bottom));
	}
		...
		return new OnFocusChangeListener() {
			...
			private ValueAnimator getUnfocusToFocusAnimation() {
				if (mUnfocusToFocusAnimation == null) {
					mUnfocusToFocusAnimation = getFocusAnimation(mFocusedColor,
							mUnFocusedColor);
				}
